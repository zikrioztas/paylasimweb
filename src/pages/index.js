      ...
      <div className="container">
        ...
        <div className="hero">
          ...
          <div className="hero-left">
            <h1>Hazır Durum <br/> Mesajları Uygulaması</h1>
          <p>Paylaşım.app ile istediğiniz arka planı seçin, binlerce hazır mesaj arasından kaydırarak dilediğinizi seçin ve hemen sosyal medya hesaplarınızda paylaşın. Üstelik tamamen ücretsiz!
          </p>

          <div className="yukle">
          
         <a href="https://play.google.com/store/apps/details?id=com.helpfulapps.paylasimapp" className="yukle-box">
          <Image
              src={googleplay}
              alt="paylasim.app logo"
              width={164}
              height={32}
            />
            </a> <a href="https://apps.apple.com/tr/app/paylasim-app-durum-mesajlar%C4%B1/id6739170806?l=tr" className="yukle-box">
