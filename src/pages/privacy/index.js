    ...
    <>
      <div className="container">
        ...
        <div className="content">
          ...
          amacıyla Advertising ID'yi (Reklam Kimliği) toplamaktadır. Bu kimlik,
          cihazınıza özgü olup kullanıcıyı kişisel olarak tanımlamaz ancak
          reklam ve uygulama işlevselliğini iyileştirmek için kullanılır.
          ...
          cihaz bilgileri, reklam etkileşimleri ve Advertising ID gibi anonim
          verileri kendi gizlilik politikası çerçevesinde toplayabilir. Daha
          fazla bilgi için lütfen AdMob Gizlilik Politikası sayfasını ziyaret
          ediniz.
          <b>Firebase:</b> Uygulama performansını izlemek ve kullanıcı
          deneyimini geliştirmek için Firebase kullanılmaktadır. Firebase,
          anonimleştirilmiş analiz verileri (ör. uygulama kullanım
          istatistikleri) toplayabilir. Firebase'in verilerinizi nasıl
          işlediğini öğrenmek için Firebase Gizlilik Politikası sayfasını
          ziyaret edebilirsiniz.
          <h3>3. Veri Güvenliği</h3>
          Uygulamamız kullanıcı verisi toplamadığı için herhangi bir kişisel
          bilgi saklanmaz. Ancak, kullanılan üçüncü taraf hizmetler (AdMob ve
          Firebase) kendi veri güvenliği standartlarına ve politikalarına
          sahiptir.
